...
```
checklistbank <command> [arguments] [flags]
```

Run `checklistbank <command> --help` for the full flag list on any command. This
...
per operation you declare in `checklistbank/domain.go`.

...
Most of these come down to network reality or how checklistbank serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

checklistbank rate-limits like any public site. checklistbank already paces
...
Where a surface is gated, checklistbank reads a cookie or token you supply
...
`checklistbank`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what checklistbank actually did
